...
const Contact = () => {
  return (
    <div>
      <section
        className="relative overflow-hidden px-30 py-20 font-sans w-full h-full overflow-hidden"
        style={{
          backgroundImage: "url('/assests/about/footerbg.jpg')",
          backgroundSize: "cover",
          backgroundPosition: "center",
          backgroundRepeat: "no-repeat",
        }}
      >
        <div className="absolute inset-9 bg-gray-700/5 rounded-4xl" />
        <div className="relative z-10 flex justify-center md:justify-start items-start gap-50">
          <motion.div
          ...
          >
            <h3 className="text-7xl font-display font-semibold mb-6 text-black text-center md:text-start">
              Let's build something{" "}
              <span className="text-secondary">Great</span>.
            </h3>
            <p className="text-xl text-black mb-5 leading-relaxed font-sans max-w-2xl text-center md:text-start">
              I am currently looking for new opportunities in Full Stack
            ...
            <div className="flex flex-col md:flex-row items-center gap-4 mt-6">
              ...
              className="w-fit flex gap-2 text-black bg-white py-3 px-4 rounded-2xl"
            >
              Say Hello
              <svg
                viewBox="0 0 64 64"
                ...
                aria-hidden="true"
                role="img"
                className="h-5 w-5 iconify iconify--emojione-monotone"
