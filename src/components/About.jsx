...
const About = () => {
  ...
  return (
    ...
    >
      ...
      <div className="bg-transparent p-10 m-0">
        {/* Intro */}
        <motion.p
          variants={itemVariants}
          className="text-start font-Poppins text-3xl md:text-4xl text-blue-900 mb-6"
        >
        ...
        <motion.h2
          variants={itemVariants}
          className=" text-start text-4xl md:text-8xl font-normal text-blue-500 leading-tight w-full mb-6"
        >
          Engineering{" "}
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-blue-900 font-semibold">
        ...
        <motion.p
          variants={itemVariants}
          className="mt-2 max-w-4xl text-start text-lg md:text-xl text-blue-900 leading-relaxed"
        >
      ...
      <motion.div
        variants={itemVariants}
        className="w-full mt-5 bg-blue-50"
      >
        <Marquee speed={40} gradient={false}>
          {techStack.map((item, index) => (
            <div
              key={index}
              className="flex items-center gap-3 px-5 py-5 backdrop-blur border-y-2 border-r-2 border-blue-200"
            >
              <img
                src={item.icon}
                alt={item.label}
