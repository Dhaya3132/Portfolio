      ...
      <div className="cardSlider py-10 flex flex-col md:flex-row gap-5 items-center">
        ...
        >
          <div className="h-46 w-full rounded-2xl">
            <img
              src="/assests/company/blog1.webp"
              alt=""
          ...
          <div className="p-3">
            <p className="text-white text-2xl font-serif italic">
              Understanding MCP, RAG, and AI Agents — The Backbone of Modern AI
              Sys
            </p>
          </div>
        </div>
        ...
        >
          <div className="h-46 w-full rounded-2xl">
            <img
              src="/assests/company/blog2.webp"
              alt=""
              className="h-full w-full rounded-2xl"
            />
          </div>
          ...
          <div className="p-3">
            <p className="text-white text-2xl font-serif italic">
              I stumbled across Google`s Quantum AI chip — and it broke my brain
              a little
            </p>
          </div>
        </div>
        ...
        >
          <div className="h-46 w-full rounded-2xl">
            <img
              src="/assests/company/blog3.webp"
              alt=""
              className="h-full w-full rounded-2xl"
            />
          </div>
          ...
          <div className="p-3">
            <p className="text-white text-2xl font-serif italic transition-all duration-300">
              AI Model vs AI Agent — A Simple Real-World Explanation
            </p>
          </div>
        </div>
      </div>
      <p className="font-serif text-center italic text-[var(--color-divider)]">
        Stay tuned—more blogs are on the way!
      </p>{" "}
    </section>
  );
};
