...
const Personal = () => {
    return (
        <section className='w-full mb-10'>
            ...
            <div className="flex flex-wrap justify-start md:justify-center text-6xl md:text-8xl py-5 md:py-20 text-gray-100 text-start md:text-center font-serif leading-tight">
